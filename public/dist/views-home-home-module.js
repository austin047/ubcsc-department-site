...
/***/ "./src/app/views/home/contact-info/contact-info.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/views/home/contact-info/contact-info.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"card\">\n  <form novalidate [formGroup]=\"contactusform\">\n    <div class=\"card-header\">\n        <strong>Contact</strong>\n        <small>Info</small>\n      </div>\n        <div class=\"card-body\">\n          <fieldset formGroupName=\"contactus\">\n            <div class=\"col-sm-6\">\n                <div class=\"form-group\">\n                  <label for=\"contactNumber\">Contact Number</label>\n                  <input type=\"text\" class=\"form-control\"  formControlName=\"number\"  id=\"contactusnumber\" value=\"{{contactUs.number.value}}\" >\n                  <div class=\"form-control-feedback\" *ngIf=\"contactUs.number.errors && (contactUs.number.dirty || contactUs.number.touched)\">\n                      <div class=\"alert alert-warning\" style=\"padding-bottom:0px\">\n                        <p *ngIf=\"contactUs.number.errors.required\">Contact Number is required</p>\n                        <p *ngIf=\"contactUs.number.errors.minlength\">\n                          - Contact Number must be {{contactUs.number.errors.minlength.requiredLength}} numbers long, we need another {{contactUs.number.errors.minlength.requiredLength - contactUs.number.errors.minlength.actualLength}} Integers </p>\n                        <p *ngIf=\"contactUs.number.errors.maxlength\">\n                          - Contact Number must be {{contactUs.number.errors.maxlength.requiredLength}} numbers long, you need to reduce {{contactUs.number.errors.maxlength.actualLength - contactUs.number.errors.maxlength.requiredLength}} Integers </p>     \n                          <p *ngIf=\"contactUs.number.errors.pattern\">\n                            - Contact Number should be of form '67888888'.\n                          </p>\n                          <!-- <pre>{{ contactUs.number.errors | json}}</pre> -->\n                      </div>\n                  </div>\n                </div>\n              </div><!--/.col-->\n              <div class=\"col-sm-6\">\n                <div class=\"form-group\">\n                  <label for=\"contactEmail\">Contact Email</label>\n                  <input type=\"text\" class=\"form-control\" formControlName=\"email\" id=\"contatctusemail\" value=\"{{contactUs.email.value}}\">\n                  <div class=\"form-control-feedback\" \n                  *ngIf=\"contactUs.email.errors && (contactUs.email.dirty || contactUs.email.touched)\">\n                    <div class=\"alert alert-warning\" style=\"padding-bottom:0px\">\n                      <p *ngIf=\"contactUs.email.errors.required\">- Contact Number is required</p>\n                      <p *ngIf=\"contactUs.email.errors.pattern\">\n                          - Invalid email, should be of form 'ubcsc@gmail.com'.\n                        </p>\n                    </div>\n                  </div>\n                </div><!--/.col-->\n              </div>\n          </fieldset>\n        </div>\n      <div class=\"card-footer\">\n        <button type=\"submit\" [disabled]=\"!contactusform.valid\" class=\"btn btn-sm btn-primary\" data-toggle=\"modal\" (click)=\"saveContactUSModal.show()\"><i class=\"fa fa-dot-circle-o\"></i> Save Changes</button>\n      </div>\n  </form>\n    \n\n  <div bsModal #saveContactUSModal=\"bs-modal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n      <div class=\"modal-dialog modal-info\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h4 class=\"modal-title\">Save Contact Information</h4>\n            <button type=\"button\" class=\"close\" (click)=\"saveContactUSModal.hide()\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n          </div>\n          <div class=\"modal-body\">\n            <p>Click Save to save current <strong>Contact Information</strong> or <strong>Cancel</strong> to abort this modal&hellip;</p>\n          </div>\n          <div class=\"modal-footer\">\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"saveContactUSModal.hide()\">Close</button>\n            <button type=\"button\" class=\"btn btn-info\" (click)=\"onSubmit(); saveContactUSModal.hide()\">Save changes</button>\n          </div>\n        </div><!-- /.modal-content -->\n      </div><!-- /.modal-dialog -->\n    </div><!-- /.modal -->"

/***/ }),

/***/ "./src/app/views/home/contact-info/contact-info.component.scss":
/*!*********************************************************************!*\
  !*** ./src/app/views/home/contact-info/contact-info.component.scss ***!
  \*********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/views/home/contact-info/contact-info.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/views/home/contact-info/contact-info.component.ts ***!
  \*******************************************************************/
...
var ContactInfoComponent = /** @class */ (function () {
    function ContactInfoComponent(homeService) {
        this.homeService = homeService;
    }
    ContactInfoComponent.prototype.createContactUsForm = function () {
        this.contactusform = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            contactus: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
    ...
    ContactInfoComponent.prototype.onSubmit = function () {
        ...
        if (this.contactusform.valid) {
            ...
            this.homeService.updateHomeInfo(this.contactUs.email.value, this.contactUs.number.value)
                ...
                console.log(data);
                _this.contactUs.email.value === data.email && _this.contactUs.number.value === data.contactNumber
                    ? sweetalert__WEBPACK_IMPORTED_MODULE_2___default()("Success!", "Email and Contact updated", "success")
                    : sweetalert__WEBPACK_IMPORTED_MODULE_2___default()("Failure!", "Email and Contact Not updated", "failure");
            });
        }
        else {
            console.log(this.contactusform.errors);
    ...
    ], ContactInfoComponent.prototype, "contactUs", void 0);
    ContactInfoComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-contact-info',
            template: __webpack_require__(/*! ./contact-info.component.html */ "./src/app/views/home/contact-info/contact-info.component.html"),
            styles: [__webpack_require__(/*! ./contact-info.component.scss */ "./src/app/views/home/contact-info/contact-info.component.scss")]
        }),
...
/***/ "./src/app/views/home/hod-message/hod-message.component.html":
/*!*******************************************************************!*\
  !*** ./src/app/views/home/hod-message/hod-message.component.html ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "<div class=\"card\">\n    <form [formGroup]=\"hodform\" >\n      <div class=\"card-header\">\n          <strong>HOD</strong>\n          <small>Message</small>\n        </div>\n        <div class=\"card-body\">\n          <div class=\"form-group\">\n              <label for=\"hodmessage\">HOD Message</label>\n              <input type=\"text\" class=\"form-control\" formControlName=\"hodmessage\" id=\"hodmessage\" value=\"{{ hodmessage.value }}\" style=\"padding-bottom: 50px;\">\n              <div class=\"form-control-feedback\"\n                  *ngIf=\"hodmessage.errors && (hodmessage.dirty || hodmessage.touched)\">\n                  <div class=\"alert alert-warning\" style=\"padding-bottom:0px\">\n                      <p *ngIf=\"hodmessage.errors.required\">hodmessage is required</p>\n                      <p *ngIf=\"hodmessage.errors.minlength\" >hodmessage must be {{hodmessage.errors.minlength.requiredLength}} characters long, we need another {{hodmessage.errors.minlength.requiredLength - hodmessage.errors.minlength.actualLength}} characters </p>\n                  </div>\n              </div>\n              <!-- <pre>{{ hodmessage.errors | json }}</pre> -->\n            </div>\n        </div>\n        <div class=\"card-footer\">\n          <button type=\"button\" [disabled]=\"!hodform.valid\" class=\"btn btn-sm btn-primary\" data-toggle=\"modal\" (click)=\"saveHODMessageModal.show()\" ><i class=\"fa fa-dot-circle-o\"></i> Save Changes</button>\n        </div>\n    </form>\n  </div>\n\n  <div bsModal #saveHODMessageModal=\"bs-modal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n      <div class=\"modal-dialog modal-info\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h4 class=\"modal-title\">Save HOD Message</h4>\n            <button type=\"button\" class=\"close\" (click)=\"saveHODMessageModal.hide()\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n          </div>\n          <div class=\"modal-body\">\n            <p>Click Save to save <strong>HOD Message</strong>  or <strong>Cancel</strong> to abort this modal&hellip;</p>\n          </div>\n          <div class=\"modal-footer\">\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"saveHODMessageModal.hide()\">Close</button>\n            <button type=\"button\" class=\"btn btn-info\" (click)=\"onSubmit(); saveHODMessageModal.hide()\">Save changes</button>\n          </div>\n        </div><!-- /.modal-content -->\n      </div><!-- /.modal-dialog -->\n    </div><!-- /.modal -->\n\n"

/***/ }),

/***/ "./src/app/views/home/hod-message/hod-message.component.scss":
/*!*******************************************************************!*\
  !*** ./src/app/views/home/hod-message/hod-message.component.scss ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/views/home/hod-message/hod-message.component.ts":
/*!*****************************************************************!*\
  !*** ./src/app/views/home/hod-message/hod-message.component.ts ***!
  \*****************************************************************/
/*! exports provided: HodMessageComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HodMessageComponent", function() { return HodMessageComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
...
var HodMessageComponent = /** @class */ (function () {
    function HodMessageComponent(homeService) {
        this.homeService = homeService;
    }
    HodMessageComponent.prototype.createHODForm = function () {
        this.hodform = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormGroup"]({
            hodmessage: this.hodmessage,
        });
    };
    HodMessageComponent.prototype.ngOnInit = function () {
        this.createHODForm();
    };
    HodMessageComponent.prototype.onSubmit = function () {
        var _this = this;
        if (this.hodform.valid) {
            this.homeService.updateHodmessage(this.hodmessage.value)
                .subscribe(function (data) {
                console.log(data);
                _this.hodmessage.value === data.hodMessage
                    ? sweetalert__WEBPACK_IMPORTED_MODULE_3___default()("Success!", "HOD message updated", "success")
                    : sweetalert__WEBPACK_IMPORTED_MODULE_3___default()("Failure!", "HOD message not deleted", "failure");
            });
        }
    };
    __decorate([
    ...
    ], HodMessageComponent.prototype, "hodmessage", void 0);
    HodMessageComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-hod-message',
            template: __webpack_require__(/*! ./hod-message.component.html */ "./src/app/views/home/hod-message/hod-message.component.html"),
            styles: [__webpack_require__(/*! ./hod-message.component.scss */ "./src/app/views/home/hod-message/hod-message.component.scss")]
        }),
        __metadata("design:paramtypes", [_home_service__WEBPACK_IMPORTED_MODULE_2__["HomeService"]])
    ], HodMessageComponent);
    return HodMessageComponent;
}());
...
/***/ "./src/app/views/home/home-slides/home-slides.component.html":
/*!*******************************************************************!*\
  !*** ./src/app/views/home/home-slides/home-slides.component.html ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "    <div class=\"card\">\n        <div class=\"card-header\">\n          <strong>Home Page</strong>\n          <small>Pictures</small>\n        </div>\n        <div class=\"card-body\">\n            <carousel [interval]=\"myInterval\" [noWrap]=\"noWrapSlides\" [(activeSlide)]=\"activeSlideIndex\">\n\t            <slide *ngFor=\"let slide of slides; let index=index\">\n\t              <img [src]=\"slide.filename\" alt=\"{{slide.filename}}\" style=\"display: block; width: 100%;\">\n\n\t              <div class=\"carousel-caption\">\n\t                <h4>Slide {{index}}</h4>\n\t                <p>{{slide.text}}</p>\n\t              </div>\n\t            </slide>\n\t        </carousel>\n\t          <br/>\n\t          <br/>\n\t          <div>\n\t            <div class=\"checkbox\">\n\t              <label><input type=\"checkbox\" [(ngModel)]=\"noWrapSlides\">Disable Slide Looping</label>\n\t            </div>\n\n\t            <span>Interval, in milliseconds (Enter a negative number or 0 to stop the interval.): </span>\n\t            <input type=\"number\" class=\"form-control\" [(ngModel)]=\"myInterval\">\n\t          </div>\n          </div>\n          <div class=\"card-footer\">\n           <!--   <button type=\"browse\" class=\"btn btn-sm btn-info\"><i class=\"fa fa-ban\"></i> Upload HomePage Image </button> -->\n              <div>\n\t            <app-upload-picture (newFile)=\"addSlide($event)\"></app-upload-picture>\n\t            <button type=\"button\" class=\"btn btn-info\"\n\t                    (click)=\"pauseSlide(); deleteImageModal.show()\">Remove Current\n\t            </button>\n\t          </div>\n          </div>\n    </div>\n\n\n<!-- \n      <div class=\"card\">\n        <div class=\"card-header\">\n          Carousel\n          <small> dynamic slides</small>\n        </div>\n        <div class=\"card-body\">\n          <carousel [interval]=\"myInterval\" [noWrap]=\"noWrapSlides\" [(activeSlide)]=\"activeSlideIndex\">\n            <slide *ngFor=\"let slide of slides; let index=index\">\n              <img [src]=\"slide.filename\" alt=\"{{slide.filename}}\" style=\"display: block; width: 50%; height: 50%; padding-bottom: 100px;\">\n\n              <div class=\"carousel-caption\">\n                <h4>Slide {{index}}</h4>\n                <p>{{slide.text}}</p>\n              </div>\n            </slide>\n          </carousel>\n          <br/>\n          <br/>\n          <div>\n            <app-upload-picture (newFile)=\"addFile($event)\"></app-upload-picture>\n            <button type=\"button\" class=\"btn btn-info\"\n                    (click)=\"deleteImageModal.show(); pauseSlide()\">Remove Current\n            </button>\n            <button type=\"button\" class=\"btn btn-info\"\n                    (click)=\"removeSlide(2)\">Remove #3\n            </button>\n          </div>\n          <div>\n            <div class=\"checkbox\">\n              <label><input type=\"checkbox\" [(ngModel)]=\"noWrapSlides\">Disable Slide Looping</label>\n            </div>\n\n            <span>Interval, in milliseconds (Enter a negative number or 0 to stop the interval.): </span>\n            <input type=\"number\" class=\"form-control\" [(ngModel)]=\"myInterval\">\n          </div>\n        </div>\n      </div> -->\n\n\n\n<div bsModal #deleteImageModal=\"bs-modal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n      <div class=\"modal-dialog modal-danger\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h4 class=\"modal-title\">Save HOD Message</h4>\n            <button type=\"button\" class=\"close\" (click)=\"deleteImageModal.hide()\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n          </div>\n          <div class=\"modal-body\">\n              <p>Click delete to <strong>delete</strong> current <strong>image</strong> or <strong>Cancel</strong> to abort this modal&hellip;</p>\n          </div>\n          <div class=\"modal-footer\">\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"deleteImageModal.hide()\">Close</button>\n            <button type=\"button\" class=\"btn btn-danger\" (click)=\"deleteImageModal.hide(); removeSlide()\">Delete Image</button>\n          </div>\n        </div><!-- /.modal-content -->\n      </div><!-- /.modal-dialog -->\n    </div><!-- /.modal -->\n\n<!-- \n <ul class=\"picturelist\">\n              <li *ngFor=\"let homepicture of homePagePic\" class=\"picturelist\">\n                <div class=\"col-sm-6 \">\n                  <img src={{homepicture.filename}} class=\"\" alt=\"{{homepicture.filename}}\" width=\"250\" height=\"250\" style=\"padding-bottom: 100px;\" />\n                </div>\n\n                <button type=\"delete\" class=\"btn btn-sm btn-danger\" data-toggle=\"modal\" (click)=\"dangerModal.show()\"><i class=\"fa fa-ban\"></i> Delete </button>\n             </li>\n            </ul> -->"

/***/ }),

/***/ "./src/app/views/home/home-slides/home-slides.component.scss":
/*!*******************************************************************!*\
  !*** ./src/app/views/home/home-slides/home-slides.component.scss ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/views/home/home-slides/home-slides.component.ts":
/*!*****************************************************************!*\
  !*** ./src/app/views/home/home-slides/home-slides.component.ts ***!
  \*****************************************************************/
...
var HomeSlidesComponent = /** @class */ (function () {
    function HomeSlidesComponent(homeService) {
        this.homeService = homeService;
        this.myInterval = 6000;
        this.activeSlideIndex = 0;
        this.pausedActivatedSlideIndex = 0;
        this.noWrapSlides = false;
        this.newFileAdded = {};
    }
    HomeSlidesComponent.prototype.addSlide = function (response) {
        //Add a file from the UploadPicture Component
        this.slides.push({ filename: response.filename, _id: response._id });
    };
    HomeSlidesComponent.prototype.removeSlide_index = function (index) {
        var toRemove = index ? index : this.activeSlideIndex;
        this.slides.splice(toRemove, 1);
    };
    HomeSlidesComponent.prototype.removeSlide = function () {
        var toRemove = this.pausedActivatedSlideIndex;
        var selectedElement = this.slides.splice(toRemove, 1);
        this.homeService.deleteHomeImage(selectedElement[0]._id)
            .subscribe(function (data) {
            data.isFulfilled
                ? sweetalert__WEBPACK_IMPORTED_MODULE_3___default()("Success!", "Image with name: " + selectedElement[0].filename + " is deleted", 'success')
                : sweetalert__WEBPACK_IMPORTED_MODULE_3___default()("Failure! ", 'Internal Server Error', 'notfound');
        });
    };
    HomeSlidesComponent.prototype.pauseSlide = function () {
        this.pausedActivatedSlideIndex = this.activeSlideIndex;
        this.noWrapSlides = true;
    };
    HomeSlidesComponent.prototype.ngOnInit = function () {
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], HomeSlidesComponent.prototype, "slides", void 0);
    HomeSlidesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-home-slides',
            template: __webpack_require__(/*! ./home-slides.component.html */ "./src/app/views/home/home-slides/home-slides.component.html"),
            providers: [
                { provide: ngx_bootstrap_carousel__WEBPACK_IMPORTED_MODULE_1__["CarouselConfig"], useValue: { interval: 1500, noPause: true } }
            ],
            styles: [__webpack_require__(/*! ./home-slides.component.scss */ "./src/app/views/home/home-slides/home-slides.component.scss")]
        }),
        __metadata("design:paramtypes", [_home_service__WEBPACK_IMPORTED_MODULE_2__["HomeService"]])
    ], HomeSlidesComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _home_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./home.service */ "./src/app/views/home/home.service.ts");
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.createFormsControlsHOD = function () {
        this.hodmessage = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("", [
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].minLength(10)
        ]);
        this.number = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("", [
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
    ...
    HomeComponent.prototype.setInitalValues = function () {
        this.homePagePic = [
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.homeService.getHomePageInfo()
            .subscribe(function (data) {
            if (data) {
                _this.homePagePic = data.homePictures;
                _this.hodmessage.setValue(data.hodMessage);
                _this.number.setValue(data.contactNumber),
                    _this.email.setValue(data.email);
                _this.contactUs = {
                    number: _this.number,
                    email: _this.email
                };
                ...
                _this.setInitalValues();
            }
        }, function (error) { console.log(error); }, function () { console.log('Complete'); });
    };
    HomeComponent.prototype.save = function (event) {
        console.log(event);
    };
    HomeComponent.prototype.deletePicture = function (id) {
...
/* harmony import */ var _hod_message_hod_message_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./hod-message/hod-message.component */ "./src/app/views/home/hod-message/hod-message.component.ts");
/* harmony import */ var _home_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./home-routing.module */ "./src/app/views/home/home-routing.module.ts");
/* harmony import */ var _contact_info_contact_info_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./contact-info/contact-info.component */ "./src/app/views/home/contact-info/contact-info.component.ts");
...
/* harmony import */ var _upload_picture_upload_picture_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./upload-picture/upload-picture.component */ "./src/app/views/home/upload-picture/upload-picture.component.ts");
/* harmony import */ var ngx_bootstrap_carousel__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ngx-bootstrap/carousel */ "./node_modules/ngx-bootstrap/carousel/index.js");
/* harmony import */ var _home_slides_home_slides_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./home-slides/home-slides.component */ "./src/app/views/home/home-slides/home-slides.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    HomeModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _hod_message_hod_message_component__WEBPACK_IMPORTED_MODULE_5__["HodMessageComponent"],
...
var HomeService = /** @class */ (function () {
     ...
     * @returns {HomeUpdate}
     */
    HomeService.prototype.updateHomeInfo = function (email, contactNumber) {
        console.log(email);
     ...
     * @returns {HodUpdate}
     */
    HomeService.prototype.updateHodmessage = function (hodMessage) {
...
/***/ "./src/app/views/home/upload-picture/upload-picture.component.html":
/*!*************************************************************************!*\
  !*** ./src/app/views/home/upload-picture/upload-picture.component.html ***!
  \*************************************************************************/
/*! no static exports found */
...
module.exports = "    \n    <button type=\"button\" class=\"btn btn-info\" (click)=\"uploadImageModal.show()\">Add image</button>   \n\n\n    <div bsModal #uploadImageModal=\"bs-modal\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n      <div class=\"modal-dialog modal-info\" role=\"document\">\n        <div class=\"modal-content\">\n          <div class=\"modal-header\">\n            <h4 class=\"modal-title\">Upload Image</h4>\n            <button type=\"button\" class=\"close\" (click)=\"uploadImageModal.hide()\" aria-label=\"Close\">\n              <span aria-hidden=\"true\">&times;</span>\n            </button>\n          </div>\n          <div class=\"modal-body\">\n            <input type=\"file\" (change)=\"set($event.target.files)\" accept=\"{{fileTypes}}\">\n             <br>\n\n            <ng-container *ngIf=\"filesize > 0.0\">File size: {{filesize}}MB </ng-container> \n\n            <br/><br/>\n             \n                   <progressbar class=\"progress progress-striped progress-animated\"  [max]=\"max\" [value]=\"percentDone\" style=\"background-color: white\">\n                     <span style=\"color:white; white-space:nowrap;\">{{percentDone}}%</span>\n                   </progressbar>\n              \n\n            <br><br>\n            <ng-container *ngIf=\"uploadSuccess\">\n              Upload Successful\n            </ng-container> \n\n           <!--  <p>Click Save to save <strong>HOD Message</strong>  or <strong>Cancel</strong> to abort this modal&hellip;</p> -->\n          </div>\n          <div class=\"modal-footer\">\n            <button type=\"button\" class=\"btn btn-secondary\" (click)=\"uploadImageModal.hide()\">Close</button>\n            <button type=\"button\" class=\"btn btn-info\" [disabled]=\"!uploadReady\" (click)=\"upload()\">Upload Image</button>\n          </div>\n        </div><!-- /.modal-content -->\n      </div><!-- /.modal-dialog -->\n    </div><!-- /.modal -->\n\n\n    <!-- \n        <div class=\"progress\">\n          <div id=\"myBar\" class=\"progress-bar progress-bar-striped progress-bar-animated active\" role=\"progressbar\"\n          aria-valuenow=\"0\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: 0%\">{{percentDone}}%</div>\n        </div> -->"

/***/ }),

/***/ "./src/app/views/home/upload-picture/upload-picture.component.scss":
/*!*************************************************************************!*\
  !*** ./src/app/views/home/upload-picture/upload-picture.component.scss ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/views/home/upload-picture/upload-picture.component.ts":
/*!***********************************************************************!*\
  !*** ./src/app/views/home/upload-picture/upload-picture.component.ts ***!
  \***********************************************************************/
...
var UploadPictureComponent = /** @class */ (function () {
    function UploadPictureComponent(http, appInitUrl) {
        ...
        this.filesize = 0;
        this.fileTypes = ".png,.jpg,.jpeg";
        this.newFile = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    }
    UploadPictureComponent.prototype.ngOnInit = function () {
    };
    UploadPictureComponent.prototype.set = function (files) {
        this.file = files[0];
        // console.log(this.file.size);
        var temp = this.file.size / 1000000;
        this.filesize = temp.toFixed(2);
        this.uploadReady = true;
    };
    UploadPictureComponent.prototype.upload = function () {
        this.uploadAndProgressSingle(this.file);
    };
    UploadPictureComponent.prototype.uploadAndProgressSingle = function (file) {
        var _this = this;
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], UploadPictureComponent.prototype, "newFile", void 0);
