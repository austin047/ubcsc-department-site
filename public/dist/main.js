...
var map = {
	"./views/aboutpage/aboutpage.module": [
		"./src/app/views/aboutpage/aboutpage.module.ts",
		"views-aboutpage-aboutpage-module"
	],
	"./views/base/base.module": [
		"./src/app/views/base/base.module.ts",
		"views-base-base-module~views-buttons-buttons-module~views-dashboard-dashboard-module~views-home-home~30374966",
		"views-base-base-module~views-home-home-module",
		"common",
		"views-base-base-module"
	],
	...
	"./views/home/home.module": [
		...
		"views-base-base-module~views-buttons-buttons-module~views-dashboard-dashboard-module~views-home-home~30374966",
		"views-home-home-module~views-notifications-notifications-module~views-people-resources-people-resour~e6ffba83",
		"views-base-base-module~views-home-home-module",
		"common",
		"views-home-home-module"
	],
...
var navItems = [
    ...
    {
        name: 'Github Download CoreUI',
        url: 'https://github.com/coreui/coreui-free-angular-admin-template',
...
/* harmony import */ var ngx_bootstrap_tabs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ngx-bootstrap/tabs */ "./node_modules/ngx-bootstrap/tabs/index.js");
...
var routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'peopleres',
                loadChildren: './views/people-resources/people-resources.module#PeopleResourcesModule'
            },
            {
                path: 'aboutpage',
                loadChildren: './views/aboutpage/aboutpage.module#AboutpageModule'
            },
            {
                path: 'base',
